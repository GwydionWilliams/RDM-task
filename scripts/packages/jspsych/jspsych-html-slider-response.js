...
jsPsych.plugins['html-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html += '<input type="range" value="'+trial.start+'" min="'+trial.min+'" max="'+trial.max+'" step="'+trial.step+'" style="width: 750px; position:left;" id="jspsych-html-slider-response-response"></input>';
    html += '<div>'
