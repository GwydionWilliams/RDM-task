...
jsPsych.plugins["RDK"] = (function() {
	...
	plugin.info = {
	    ...
	    parameters: {
		    ...
		    dot_color_pre: {
		      type: jsPsych.plugins.parameterType.STRING,
		      pretty_name: "Dot color pre transition",
		      default: "white",
		      description: "The color of the dots pre-transition."
		    },
            dot_color_post: {
		      type: jsPsych.plugins.parameterType.STRING,
		      pretty_name: "Dot color post transition",
		      default: "white",
		      description: "The color of the dots post-transition."
		    },
            t_color_transition: {
		      type: jsPsych.plugins.parameterType.INT,
		      pretty_name: "Time of color transition",
		      default: 500,
		      description: "The time at which the dots change color."
		    },
		    background_color: {
		      type: jsPsych.plugins.parameterType.STRING,
	...
	plugin.trial = function(display_element, trial) {
        ...
        trial.dot_color = assignParameterValue(trial.dot_color_pre, "white");
		trial.dot_color_pre = assignParameterValue(trial.dot_color_pre, "white");
        trial.dot_color_post = assignParameterValue(trial.dot_color_post, "white");
        trial.t_color_transition = assignParameterValue(trial.t_color_transition, trial.trial_duration/2);
		...
		var dotColorPre = trial.dot_color_pre; //Color of the dots
        var dotColorPost = trial.dot_color_post;
        var tColorTransition = trial.t_color_transition;
		...
		*/
		...
		var dotColorPreArray;
        var dotColorPostArray;
		...
		function end_trial() {
			...
			var trial_data = {
				...
				"dot_color_pre": trial.dot_color_pre,
                "dot_color_post": trial.dot_color_post,
                "t_color_transition": trial.t_color_transition,
		...
		function setUpMultipleApertures(){
			...
			dotColorPreArray = setParameter(dotColorPre);
            dotColorPostArray = setParameter(dotColorPost);
		...
		function initializeCurrentApertureParameters(){
			...
			dotColorPre = dotColorPreArray[currentApertureNumber];
            dotColorPost = dotColorPostArray[currentApertureNumber];
			...
			function animate() {
				...
				//Else continue with another frame request
					...
					if ( (!timerHasStarted) && (trial.trial_duration > 0) ){
                        ...
                        trial.dot_color = trial.dot_color_pre
                        window.setTimeout(function(){trial.dot_color = trial.dot_color_post}, trial.t_color_transition)
					}
